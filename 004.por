 ...
 * têm prioridade sobre as operações de soma (+) e subtração (-).
 * Além disso, o exemplo demonstra como os parênteses podem ser utilizados
 * para alterar esta prioridade, fazendo com que uma operação de soma
 * ocorra antes de uma operação de multiplicação.
 */
programa {
  funcao inicio() {
    ...
    /**
     * Neste exemplo, a operação de divisão (/) será executada
     * primeiro, seguida pela operação de multiplicação (*). Por
     * último, será executada a operação de soma (+)
     */
